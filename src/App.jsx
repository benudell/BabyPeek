...
"imagePrompt": Based on the ACTUAL features you observed in the parent photos above, write a highly detailed prompt for a photorealistic image generator. Explicitly describe the child's specific blended physical traits — mention exact hair color/texture, eye color, skin tone, and facial features inherited from each parent. The child should genuinely look like a believable blend of these two specific people, with a subtle hint of Irish heritage — perhaps a very slight touch of warmth in the complexion, or a gentle softness to the features — nothing overt, just a natural understated quality. Warm, natural portrait, soft lighting, family portrait style. IMPORTANT: If the suggested name is "Ben" or "Amanda" (case-insensitive), the child MUST be wearing Milwaukee Brewers baseball gear. If the name strongly indicates a specific cultural or ethnic background, reflect that authentically.
